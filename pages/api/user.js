...
export default async function handler(req, res) {
    try {
      ...
      res.status(200).json({ id: uuid.v4(), 
                                duration: _duration, endTime: _end_time, hasSaleEnded: _has_sale_ended, investToken: _invest_token, investroInfoMap: _investor_info_map,
